...
RSpec.describe 'Plays API' do
  ...
  describe 'GET api/authors/:author_id/plays' do
    before {
      get "/api/v1/authors/#{author_id}/plays", params: {play: {author_id: author_id}}, as: :json, headers: authenticated_header(user)
    }
  ...
  describe 'GET api/plays' do
    before {
      get "/api/v1/plays", as: :json, headers: authenticated_header(user)
    }
  ...
  describe 'GET /authors/:author_id/plays/:id' do
    before { get "/api/v1/authors/#{author_id}/plays/#{id}", as: :json, headers: authenticated_header(user) }
  ...
  describe 'GET /plays/:id' do
    before { get "/api/v1/plays/#{id}", as: :json, headers: authenticated_header(user) }
  ...
  describe 'POST /authors/:author_id/plays' do
    ...
    context 'when request attributes are valid' do
      before { post "/api/v1/authors/#{author_id}/plays", params: valid_attributes, as: :json, headers: authenticated_header(user) }
    ...
    context 'when an invalid request' do
      before { post "/api/v1/authors/#{author_id}/plays", params: { play: { genre: 'failure' } }, as: :json, headers: authenticated_header(user) }
  ...
  describe 'PUT /api/authors/:author_id/plays/:id' do
    ...
    before { put "/api/v1/authors/#{author_id}/plays/#{id}", params: valid_attributes, as: :json, headers: authenticated_header(user) }
  ...
  describe 'get play script and skeleton' do
    ...
    before {
      ...
      get "/api/v1/plays/#{id}/play_script/", as: :json, headers: authenticated_header(user)
    }
    ...
    it 'returns a play skeleton' do
      get "/api/v1/plays/#{id}/play_skeleton/", as: :json, headers: authenticated_header(user)
      expect(json['acts'].size).to eq(3)
      expect(json['acts'][0]['scenes'].size).to eq(3)
      expect(json['acts'][0]['scenes'][0]['french_scenes'].size).to eq(3)
  ...
  describe 'verify on-stages' do
    ...
    it 'returns on_stages organized by acts' do
      get "/api/v1/plays/#{id}/play_act_on_stages/", as: :json, headers: authenticated_header(user)
    ...
    it 'returns on_stages organized by french_scenes' do
      get "/api/v1/plays/#{id}/play_french_scene_on_stages/", as: :json, headers: authenticated_header(user)
    ...
    it 'returns on_stages organized by scenes' do
      get "/api/v1/plays/#{id}/play_scene_on_stages/", as: :json, headers: authenticated_header(user)
      expect(json.size).to eq(9)
      expect(json[0]['find_on_stages'].size).to eq(3)
    end

    it 'returns on_stages for whole play' do
      get "/api/v1/plays/#{id}/play_on_stages/", as: :json, headers: authenticated_header(user)
  ...
  describe 'DELETE /authors/:id' do
    before { delete "/api/v1/authors/#{author_id}/plays/#{id}", as: :json, headers: authenticated_header(user) }
